...
public class AddProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (fileName1.equals("")) {
                flag1 = false;
                error.setImgError("Please select a image");
            }
            ...
            if (flag1) {
                MoonCakeDTO dto = new MoonCakeDTO(productID, productName, description, fileName1, "Active", Float.parseFloat(price), Integer.parseInt(unit), categoryID, fromsqlDate, tosqlDate, today, userID);
                ...
                if (check) {
                    ...
                    url = SUCCESS;
                    request.setAttribute("MESS", "Add new product success");
                }
            } else {
                request.setAttribute("ERROR", error);
                url = ERROR;
            ...
            LOGGER.debug("Error at AddProductController" + e.getMessage());
